...
public:
    ...
    smart &operator=(const smart &iObj)
    {
        ...
        Because there may be chance that some data already existing
        Eg,
            smart<classA> sp3(sp1); // copy c'tor called
            sp3 = sp2;
        In this situation, we need to clean the existing m_ptr and m_count.

        But, cannot delete the exiting 'this' pointer object which it holds.
    ...
    {
        smart temp(iPtr); // this will call the parameterized constructor
