 ...
 *			For instance, the function "func_c" is created as "func_c" only
 *
 *	Note:
...
// Note: overloading NOT allowed for fucntion with 'extern "C" linkage'
// for example, extern "C" void func_c(int) --> NOT allowed. Will give compilation error.
/*******************************************/
